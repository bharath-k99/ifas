    ...
    function AudioRecorderPlayer() {
        ...
        this.addRecordBackListener = function (e) {
            if (Platform.OS === 'android') {
                _this._recorderSubscription = DeviceEventEmitter.addListener('rn-recordback', e);
            }
            else {
        ...
        this.addPlayBackListener = function (e) {
            if (Platform.OS === 'android') {
                _this._playerSubscription = DeviceEventEmitter.addListener('rn-playback', e);
            }
            else {
                var myModuleEvt = new NativeEventEmitter(RNAudioRecorderPlayer);
         ...
         */
        this.startRecorder = function (uri, meteringEnabled, audioSets) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (!this._isRecording) {
                    ...
                    return [2 /*return*/, RNAudioRecorderPlayer.startRecorder(uri, meteringEnabled, audioSets)];
                }
         ...
         * @returns {Promise<string>}
         */
        this.startPlayer = function (uri) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!uri) {
                    uri = 'DEFAULT';
                }
